...
def CondensatetradesOnline(lastKnowTradeTime, currentTime):
    ...
    var = 'Condensated {0} Trades'.format(len(tradesCondensation[tradesCondensation.index >= currentTime]))
    LogEvent(var)
    return True   
...
def ConultarOnline():
    ...
    TradesColsNames = ['price', 'volume', 'time', 'buy-sell', 'market/limit', 'miscellaneous']
