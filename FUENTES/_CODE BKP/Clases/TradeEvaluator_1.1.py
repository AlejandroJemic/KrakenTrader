'''
TradeEvaluator v1.1 17-12-2017
...
class TradeValues:
    ...
    closeTime = datetime.now()     # tiempo cierre operacion
...
class TradeEvaluator:
    ...
    def OpenerCloserEvaluator (self,bh, tc, DBA, pOpenCloseValues = None, pIsBackTest = False):
        '''
